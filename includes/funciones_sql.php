...
// Función para buscar productos que contentan la cadena de búsqueda
...
// Función para buscar el  id_usuario a traves del email
...
// Función para buscar los pedidos de un usuario a traves de su email
...
// Función para buscar los productos de un pedido
...
// Función para buscar la suma del coste de todos los productos de un pedido
...
// Función para buscar un producto a traves de su id_producto
...
// Función para buscar el id_producto de un producto a traves de su nombre completo (nombre + marca)
...
// Función para buscar el stock de un producto
...
// Función para buscar el id_usuario de un usuario a traves de su email
...
// Función para insertar un producto al pedido
...
// Función para borrar un usuario de la tabla usuarios a traves de su id_usuario 

// No funciona, si sabes porque, por favor, dime por qué. En workbench funciona perfectamente.
