...
<body>
    ...
    <header>
        ...
        <div class="navbarCabecera">
            ...
            <div class="subNavbarCabecera">
                <a href="pages/realizar_pedido.php">Cesta</a>

                <!-- Si existe la sesión 'email', se muestra "Mi cuenta", si no, se muestra "Iniciar sesión" -->
        ...
        <div class="menuCabecera">
         ...
         <!-- Barra de navegación vertical con las categorías para tablets y móviles-->
         ...
         <nav id="menuCategoriasVertical">
             ...
             <!-- Script para desplegar el menu vertical al pulsar el botón -->
        ...
        <!-- Sección CS:GO / League of legends -->
        ...
        <div class="comprarAhora" id="horaDeJugar">
            <div class="textoComprarAhora" id="centrarJugar">
                ...
                <!-- Botón para ir a la tienda buscando gaming -->
                <a href="pages/tienda.php?buscar=gaming">COMPRAR AHORA</a>
            </div>
        </div>
   

        <!-- Sección de categorías que llevan a la tienda con $_GET['categoria'] -->
        ...
        <!-- Video de Corsair con enlace a la tienda con $_GET['buscar'] = "corsair" -->
    ...
    <footer>
        <div class="footerFila1">
            ...
            <!-- Si existe la sesión de email el botón lleva a la cuenta de lo contrario al inicio de sesión -->
            ...
            <!-- Botón que abre google maps con la localización de la universidad -->
        ...
        <div class="footerFila2">
            ...
            <div class="footerCol2">
                <div class="tituloFCol2">
                     ...
                     <!-- Mini mapa con la localización de la universidad -->
