    ...
    <div class="container" style="min-height:50vh;">
        ...
        <table class="table">
                ...
                <?php 
                    ...
                    // Recorre el array de la cesta y muestra los productos, la cantidad de cada uno y su precio
                    $precioTotal = 0;
                    foreach ($carrito as $producto => $cantidad) { 
                        ...
                        // Si la cantidad seleccionada por el cliente es mayor que el stock, se iguala la cantidad al stock

                        if ($cantidad > $stock['stock']){
                            $cantidad = $stock['stock'];
                        }
                        // Se calcula el precio total de la compra añadiendo el precio de cada producto por la cantidad de cada uno
